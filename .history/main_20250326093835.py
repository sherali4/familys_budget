...
category_keyboard = InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [InlineKeyboardButton(
            text="👕 Одежда", callback_data="category_Одежда")],
        [InlineKeyboardButton(text="🍔 Еда", callback_data="category_Еда")],
...
async def request_order(message: Message):
    await message.answer("Введите заказ в формате: \n/order Товар 150000", reply_markup=category_keyboard)
